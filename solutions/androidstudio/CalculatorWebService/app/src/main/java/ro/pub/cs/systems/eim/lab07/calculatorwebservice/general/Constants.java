...
public interface Constants {
    ...
    public static String  GET_WEB_SERVICE_ADDRESS  = "http://eim2016.andreirosucojocaru.ro/exemple/laboratoare/laborator07/calculator/calculator_get.php";
    public static String  POST_WEB_SERVICE_ADDRESS = "http://eim2016.andreirosucojocaru.ro/exemple/laboratoare/laborator07/calculator/calculator_post.php";
